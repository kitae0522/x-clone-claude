...
## Phase 16: 프로필 이미지 S3 전환 (#60) (진행중)
- [x] 프론트엔드 useUploadProfileImage → media-service 경유 + 폴링
- [x] 백엔드 DTO validator url 태그 제거 (media-service URL 허용)
- [x] 백엔드 이미지 URL 빈 문자열 보존 로직
- [x] validator 테스트 동기화
- [x] 빌드 & 테스트 통과
- [ ] 코드 리뷰
- [ ] PR 생성 및 이슈 연결
